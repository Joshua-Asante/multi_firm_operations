...
```python
assert_file_contains("strategies/aegis_v4_3.pine", "dayofmonth >= 29",
...
| 7 | pre-04-22 | Aegis EOM "last 3 trading days" vs Pine `dayofmonth >= 29` | `assert_file_contains("strategies/aegis_v4_3.pine", "dayofmonth >= 29")` | Code-vs-doc | Y (strict) |
